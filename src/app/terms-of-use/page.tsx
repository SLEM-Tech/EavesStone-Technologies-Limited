						...
						<div id='termsOfUse' className='text-gray-600 space-y-6'>
							<div>
								...
								<p className='mt-3 leading-[1.8] text-xs md:text-sm xl:text-base'>
									By accessing the {CompanyName} platform and initiating a
									procurement request, you agree to be bound by the following
							...
							<ul className='list-none space-y-5 text-xs md:text-sm xl:text-base'>
								<li>
									...
									{CompanyName} operates on a two-phase payment model.{" "}
								...
								<li>
									...
									7-14 days; Sea: 45-60 days) are estimates. {CompanyName} is
									not liable for delays caused by international carrier
									schedules, weather conditions, or Nigerian Customs Service
									inspections.
								</li>
								...
								<li>
									...
									market volatility. {CompanyName} reserves the right to adjust
									invoices if there is a significant shift in the exchange rate
									between the time of order placement and the time of actual
									procurement.
								</li>
								...
								<li>
									...
									list. {CompanyName} reserves the right to cancel procurement
									for items deemed illegal or restricted.
								</li>
							...
							<div className='bg-slate-50 p-4 rounded-2xl border border-slate-100 mt-6'>
								<p className='leading-[1.6] text-xs md:text-sm italic'>
									...
									{CompanyName} acts as a procurement and logistics facilitator.
									We are not the manufacturers of the goods purchased. Any
									product warranty claims must be directed to the original
									manufacturer, though we will provide reasonable assistance in
					...
					{activeTab === "privacyPolicy" && (
						<div id='privacyPolicy' className='text-slate-600 space-y-8'>
							...
							<div>
								...
								<p className='mt-3 leading-[1.8] text-xs md:text-sm xl:text-base'>
									{CompanyName} collects personal information to provide a
									secure, seamless international procurement and logistics
								...
								<ul className='mt-4 space-y-3 text-xs md:text-sm xl:text-base list-none pl-0'>
									...
									<li className='flex items-start gap-3'>
										...
										<span>
											...
											protect the {CompanyName} ecosystem.
										</span>
									</li>
									<li className='flex items-start gap-3'>
										<div className='mt-1.5 size-1.5 rounded-full bg-primary-100 shrink-0' />
							...
							<div className='bg-slate-900 text-white p-8 rounded-[2.5rem] shadow-xl relative overflow-hidden'>
								...
								<div className='relative z-10'>
									...
									<p className='mt-4 leading-[1.8] text-xs md:text-sm xl:text-base opacity-80'>
										{CompanyName} employs bank-grade AES-256 encryption to
										protect your sensitive identifiers (BVN/NIN). Your data is
										stored in secure, siloed environments and is never sold to
