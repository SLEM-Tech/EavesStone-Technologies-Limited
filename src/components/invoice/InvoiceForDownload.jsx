				...
				<Page size='A4' style={styles.page}>
					...
					<View style={styles.invoiceSecond}>
						...
						<View>
							...
							<Text style={styles.info}>#{data?.customer_id}</Text>
						</View>
						<View>
							<Text style={styles.title}>Customer Info</Text>
							<Text style={styles.info}>{data?.billing?.first_name}</Text>
							<Text style={styles.info}>
								{data?.billing?.address_1?.substring(0, 25)}
							</Text>
							<Text style={styles.info}>
					...
					<View style={styles.invoiceThird}>
						<View>
							...
							<Text style={styles.info}> {data.payment_method} </Text>
						</View>
					...
					>
						<Text>
							Thank you{" "}
							<Text style={styles.thanks}>{data.billing?.first_name},</Text>{" "}
