...
export const SITE_NAME = "EavesStone Technology Limited";
...
export const SEODATA: Record<string, SEOConfig> = {
	default: {
		...
		description: `${SITE_NAME} provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.`,
		keywords: [
	...
	home: {
		...
		description: `Innovate and grow with ${CompanyShortName}. We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.`,
		keywords: [
	...
	login: {
		...
		description: `Access your ${CompanyShortName} client dashboard to track project progress, manage subscriptions, and collaborate with your dev team.`,
		keywords: [
			"Client login",
			"Project tracking portal",
			`${CompanyShortName} dashboard access`,
		],
	},
	register: {
		title: `Partner with Us | Join ${SITE_NAME}`,
		description: `Create an account to start your project journey with ${CompanyShortName} and access premium tech resources.`,
		keywords: [
			`Get started with ${CompanyShortName}`,
			"Project onboarding",
			"Digital partnership",
		],
	},
